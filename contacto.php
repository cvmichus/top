    ...
    <div class="container">
      <div class="row">
        ...
        <div class="title text-center" >
          ...
          <p>Estamos a tus órdenes para resolver cualquier duda que tengas sobre nuestros servicios, por favor contáctanos por el medio de tu preferencia o visítanos en nuestra sucursal. Si deseas realizar impresiones lo puedes hacer en línea y recoger en la sucursal.</p>
        ...
        <div class="contact-details col-md-6 " >
          <h3>Contáctanos</h3>
          <p>Única sucursal Felipe Ángeles #236, Fracc. Tecnológico, Querétaro, Qro.</p>
          <ul class="contact-short-info" >
            <li>
              <i class="tf-ion-ios-home"></i>
              <span>Felipe Ángeles #236, Fracc. Tecnológico, Querétaro, Qro.</span>
            </li>
            <li>
              <i class="tf-ion-android-phone-portrait"></i>
              <span>Telefono: (442) 217 4881 / 182 0652</span>
            </li>
          
            <li>
              <i class="tf-ion-android-mail"></i>
              <span>Email: ventas@top-computing.com</span>
            </li>
          </ul>
          <!-- Footer Social Links -->
          <div class="social-icon">
            <ul>
              <li><a href="https://es-es.facebook.com/TopComputing1/"><i class="tf-ion-social-facebook"></i></a></li>
	...
	<div class="theme-option">
		...
		<div class="colors">
			<ul class="list-inline">
				<li class="list-inline-item color-1"></li>
				<li class="list-inline-item color-2"></li>
				<li class="list-inline-item color-3"></li>
				<li class="list-inline-item color-4"></li>
			</ul>
		</div>
	</div>
</div>
...
<style>
	...
	.option .theme-option h5{
		font-size: 22px;
	}
	.option .theme-option .colors{
		margin-top: 50px;
	}

	.option .theme-option .colors li{
		width: 40px;
		height: 40px;
		border-radius: 3px;
	}
	.option .theme-option li:not(last-child){
		margin-right: 20px;
	}
