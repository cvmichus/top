        ...
        <div class="row " >
          <div class="col-lg-12">
            ...
            <div class="portfolio-filter">
              ...
              <button type="button" data-filter=".photography">Impresion en gran Formato</button>
              <button type="button" data-filter=".ios">Impresion en Rigidos</button>
              <button type="button" data-filter=".development">Offset</button>
              <button type="button" data-filter=".design">Impresiones</button>
               <button type="button" data-filter=".vinil">Vinil</button>
              <button type="button" data-filter=".tresd">3D</button>
            </div>
                  ...
                  <div class="col-md-3 col-sm-6 col-xs-6 mix photography">
                    <div class="portfolio-block">
                      ...
                      <div class="caption">
                        ...
                        <h4><a href="">Telas</a></h4>
                      </div>
                    </div>
                  </div>

                   <div class="col-md-3 col-sm-6 col-xs-6 mix vinil">
                    <div class="portfolio-block">
                      ...
                      <div class="caption">
                        ...
                        <h4><a href="">Vinil</a></h4>
                      </div>
                    </div>
                  </div>

                  <div class="col-md-3 col-sm-6 col-xs-6 mix tresd">
                    <div class="portfolio-block">
                      <img class="img-responsive" src="images/portfolio/portfolio-9.jpg" alt="">
                      <div class="caption">
                        <a class="search-icon" href="images/portfolio/portfolio-9.jpg" data-lightbox="image-1">
                          <i class="tf-ion-ios-search-strong"></i>
                        </a>
                        <h4><a href="">3D</a></h4>
                      </div>
