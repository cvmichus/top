...
<section class="hero-area">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<div class="block">
					<h1 class="wow fadeInUp" data-wow-duration=".5s" data-wow-delay=".3s" >Top <br> Computing</h1>
					<p class="wow fadeInUp" data-wow-duration=".5s" data-wow-delay=".5s">Enfocados en ofrecerte las mejores y mas accesibles servicios de Impresión.</p>
					<ul class="list-inline wow fadeInUp" data-wow-duration=".5s" data-wow-delay=".7s">
						<li>
							<a data-scroll href="#services" class="btn btn-main">Explorar Mas</a>		
						</li>
						<li>
							<a data-scroll href="#about" class="btn btn-transparent">¿Por que Nosotros? </a>			
						</li>
					</ul>
				</div>
			</div>
...
Start About Section
==================================== -->
<section class="service-2 section" id="services" >
  <div class="container">
    <div class="row">
      ...
      <div class="title text-center"  >
        ...
        <p>
        	Estamos enfocados en ofrecerte los mejores y mas accesibles servicios de Impresión <br> </p>
        <div class="border"></div>
      </div>
      <!-- /section title -->

      <div class="col-md-4 text-center">
        <img src="images/about/member2.jpg" class="inline-block" alt="">
      </div>
      <div class="col-md-8">
        <div class="row text-center">
          <div class="col-md-6 col-sm-6 col-xs-12">
            <div class="service-item">
              ...
              <h4>Calidad y Rapidez</h4>
              <p>Entregamos a tiempo con la mejor calidad de Impresión con garantia  a nuestros clientes.</p>
            </div>
          </div><!-- END COL -->
          <div class="col-md-6 col-sm-6 col-xs-12">
            <div class="service-item">
              ...
              <h4>Logotipos</h4>
              <p>Te ayudamos en idear lo mejor para operar el marketing , tu logo.</p>
            </div>
          </div><!-- END COL -->
          <div class="col-md-6 col-sm-6 col-xs-12">
            <div class="service-item">
              <i class="tf-ion-ios-email-outline"></i>
              <h4>Impresión sin Limites</h4>
              <p>Conoce todos nuestros servicios, contamos con mas medios de Impresión.</p>
            </div>
          </div><!-- END COL -->
          <div class="col-md-6 col-sm-6 col-xs-12">
            <div class="service-item">
              <i class="tf-ion-ios-locked-outline"></i>
              <h4>Imprime donde sea</h4>
              <p>Crea o sube tu archivo, paga y recoge o recibe  donde estes.</p>
            </div>
          </div><!-- END COL -->
        </div>
      </div>
	...
	<div class="container">
		<div class="row">
			...
			<div class="title text-center"  >
				...
				<p>Estas son sólo algunas de las cosas por las que te invitamos a conocernos:</p>
				<div class="border"></div>
			</div>
			...
			<div class="col-md-6">
				<ul class="checklist">
                    <li>Manejamos la mejor calidad de impresión a muy bajos costos.</li>
                    <li>Contamos con una amplia gama de productos de gran comercial e industrial</li>
                    <li>Te podemos sugerir si así lo desea diferentes materiales, aplicaciones y estructuras para la proyección de tu empresa.</li>
                    <li>Trabajamos con diferentes socios comerciales y proveedores por lo que nuestro servicio le libera de la carga administrativa y altos costos que implica trabajar con empresas distintas.</li>
                    <li>Además tenemos como respaldo un servicio profesional de diseño en el desarrollo de identidad corporativa.</li>
                </ul>
				<a href="#" class="btn btn-main mt-20">Visita nuestrois Servicios</a>
			</div>
		</div> 		
	</div>   	
</section> 
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12 text-center">
				...
				<p>Solo deja tus datos y nos pondremos en contacto contigo.</p>
				<form id="contact-form" method="post" action="sendmail2.php" role="form">
					Nombre: <input type="text" name="nombre" id="nombre" value"">
					Telefono: <input  type="text" name="telefono" id="telefono" value"">
					<a href="" class="btn btn-main">Enviar Solicitud</a>
				</form>
		...
		<section  class="counter-wrapper section-sm" >
			<div class="container">
				<div class="row">
					<div class="col-md-12 text-center">
						<div class="title">
							<h2>Algunos datos Claves</h2>

							<p>Somos una empresa especializada en proveer material impreso para pequeñas, medianas y grandes empresas bajo el concepto de "todo en uno" manejando una gran variedad de artículos, te damos a conecer algunos datos curiosos:</p>
						</div>
					</div>
					<!-- first count item -->
					...
					<div class="col-md-3 col-sm-6 col-xs-6 text-center " >
						<div class="counters-item">
							...
							<div>
							    <span class="counter" data-count="24">25</span>
							</div>
